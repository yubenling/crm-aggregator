...
//		点击确定以后弹出其他指定商品
       $(".Qita").click(function(){
		...
		$(".test_number").blur(function(){
            ...
            //3
             $('.tui3 .save').click(function(){
            	var a = parseFloat( $(".tui3 .Money").val() );
	          	var b = parseFloat( $(".tui3 .Money2").val() )
            	$(".tui3 .Time").text($(".tui3 .Time11").val());
    			$(".tui3 .Time2").text($(".tui3 .Time22").val());
    			$(".tui3 .Money").text($(".tui3 .Money11").val()+'元'+"~");
				$(".tui3 .Money2").text($(".tui3 .Money22").val()+'元');
				if (   a>b   ) {
          		confirm("a需小于b")
    			} else
...
//          点击短信设置保存	
        ...
        //3
        $('.tui3 .SaveS').click(function(){
        	$(".SaveS1").show();
			$(".SaveS2").hide();
			$(".SaveS3").hide();
			$(".tui3 .Letter").val($(".tui3 .Letter11").val());
        }) 
