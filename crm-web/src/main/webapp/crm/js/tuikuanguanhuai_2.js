...
//		点击确定以后弹出其他指定商品
       $(".Qita").click(function(){
		...
		$(".test_number").blur(function(){
            ...
            //2
             $('.tui2 .save').click(function(){
            	var a = parseFloat( $(".tui2 .Money").val() );
	          	var b = parseFloat( $(".tui2 .Money2").val() )
            	$(".tui2 .Time").text($(".tui2 .Time11").val());
    			$(".tui2 .Time2").text($(".tui2 .Time22").val());
    			$(".tui2 .Money").text($(".tui2 .Money11").val()+'元'+"~");
				$(".tui2 .Money2").text($(".tui2 .Money22").val()+'元');
				if (   a>b   ) {
          		confirm("a需小于b")
    			} else
...
//          点击短信设置保存	
        ...
        //2
        $('.tui2 .SaveS').click(function(){
        	$(".SaveS1").show();
			$(".SaveS2").hide();
			$(".SaveS3").hide();
			$(".tui2 .Letter").val($(".tui2 .Letter11").val());
        }) 
