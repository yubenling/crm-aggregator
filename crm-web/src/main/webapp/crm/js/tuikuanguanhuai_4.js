...
//		点击确定以后弹出其他指定商品
       $(".Qita").click(function(){
		...
		$(".test_number").blur(function(){
            ...
            //4
             $('.tui4 .save').click(function(){
            	var a = parseFloat( $(".tui4 .Money").val() );
	          	var b = parseFloat( $(".tui4 .Money2").val() )
            	$(".tui4 .Time").text($(".tui4 .Time11").val());
    			$(".tui4 .Time2").text($(".tui4 .Time22").val());
    			$(".tui4 .Money").text($(".tui4 .Money11").val()+'元'+"~");
				$(".tui4 .Money2").text($(".tui4 .Money22").val()+'元');
				if (   a>b   ) {
          		//confirm("a需小于b")
    			} else
...
//			//<!-------------------    插入付款链接------------------------------------>
 ...
 //          点击高级设置取消	
        ...
        //4
        $('.tui4 .SaveS').click(function(){
        	$(".SaveS1").show();
			$(".SaveS2").hide();
			$(".SaveS3").hide();
			$(".tui4 .Letter").val($(".tui4 .Letter11").val());
        }) 
 //          点击短信设置取消	
