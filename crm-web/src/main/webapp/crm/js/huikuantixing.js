...
$(function(){
    ...
    $(".Save").click(function(){
        ...
        var qqq=$(".ZhiXingLeiXing").find(".bgc_check_blue").next("div").text();
        $(".LiJiTiXing").text(qqq);
...
//        $(this).next().children(".text_count").text($(this).val().length);
    ...
    $(".ZhanKai").click(function(){
		if($(".LiuCheng").css("display")=="none"){
			$(".LiuCheng").slideDown(1000);
		}else if($(".LiuCheng").css("display")=="block") {$(".LiuCheng").slideUp(1000)};
		$(".JTS").toggle();
		$(".JTX").toggle();
