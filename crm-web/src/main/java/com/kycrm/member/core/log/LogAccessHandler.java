package com.kycrm.member.core.log;
...
import com.kycrm.member.core.http.HttpService;
...
public class LogAccessHandler extends LogAccessForwardHandler {
    ...
    private static final Logger logger = LoggerFactory.getLogger(LogAccessHandler.class);
    ...
    protected String handleOrderLogType(Map map) {
    	logger.info("11111111111111111111111111111111111111111111111111");
        Map<String, String> paramMap = new TreeMap<String, String>();
        LogAccessDTO logAccessDTO = (LogAccessDTO) map.get(LogAccessDTO.class.getName());
        paramMap.put("time", String.valueOf(System.currentTimeMillis()));
        paramMap.put("appKey", LOG_APP_KEY);
        ...
        logger.info("**********************上传订单返回结果为：" + jsonResult);
        return jsonResult;
    }
