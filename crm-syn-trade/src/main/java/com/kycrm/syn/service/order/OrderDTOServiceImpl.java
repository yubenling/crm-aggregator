package com.kycrm.syn.service.order;
...
import com.kycrm.syn.dao.order.IOrderLostDao;
import com.kycrm.syn.service.trade.TradeErrorMessageService;
...
public class OrderDTOServiceImpl implements IOrderDTOService {
	...
	@Autowired
	private IOrderLostDao orderLostDao;
	...
	public Long getCount(Long uid) throws Exception {
		return this.orderDao.getCount(uid);
	}
