 ...
 * @Date 2018年11月27日下午4:16:37
 * @Tags
 */
public class SynchronizeAddNumber implements Runnable {
	
	private Logger logger = LoggerFactory.getLogger(SynchronizeAddNumber.class);
	...
	public SynchronizeAddNumber(Long uid, String column, ITradeDTOService tradeDTOService,
