...
import com.kycrm.member.dao.syntrade.item.ItemDaosyn;
...
// @Transactional
@MyDataSource
public class ItemServiceImplsyn /*implements IItemService*/ {
	private static final Logger logger = LoggerFactory.getLogger(ItemServiceImplsyn.class);
	@Autowired
	private ItemDaosyn itemDao;
