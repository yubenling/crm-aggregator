...
import com.kycrm.member.dao.syntrade.member.IMemberReceiveDetailDaosyn;
...
@Service
@MyDataSource
public class MemberReceiveDetailImplsyn {

	@Autowired
	private IMemberReceiveDetailDaosyn memberReceiveDetail;
