package com.kycrm.member.service.synctrade.message;
...
import com.kycrm.member.dao.syntrade.message.ISmsBlackListDTODaosyn;
...
import com.kycrm.member.service.synctrade.user.JudgeUserUtilsyn;
...
@MyDataSource
@Service
public class SmsBlackListDTOServiceImplsyn /*implements ISmsBlackListDTOService*/{
	private static final Log logger = LogFactory.getLog(SmsBlackListDTOServiceImplsyn.class);
	@Autowired
	private ISmsBlackListDTODaosyn smsBlackListDao;
	@Autowired
	private JudgeUserUtilsyn judgeUserUtil;
//	@Autowired
