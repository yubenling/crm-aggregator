...
public class SendMessageUtil {
	...
	static{
		...
		USERCODE= resource.getString("sendMessageUtil.username");
		PASSWORD= resource.getString("sendMessageUtil.password");
		URL=resource.getString("sms.url");
	}
	//线上账号
	/*public static   String USERCODE ="keyuncrm";
	public static   String PASSWORD ="l7kpi74z";*/
