...
public class SendMessageUtilForHangYe {
	...
	static{
		...
		USERCODE= resource.getString("utilForHangYe.username");
		PASSWORD= resource.getString("utilForHangYe.password");
		URL=resource.getString("sms.url");
	}
	//线上测试
	/*public static   String USERCODE ="keyunhy";
	public static   String PASSWORD ="j3s7huph";*/
