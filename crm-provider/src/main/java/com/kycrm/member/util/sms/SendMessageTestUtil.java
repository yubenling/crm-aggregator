...
public class SendMessageTestUtil {
	...
	private static Log logger = LogFactory.getLog(SendMessageTestUtil.class);
    
	private static String YXCS_USERCODE =null;
	private static String YXCS_PASSWORD =null;
	public static   String URL =null;
	
	
	static{
		ResourceBundle  resource=ResourceBundle.getBundle("dev");
		YXCS_USERCODE= resource.getString("testUilt.username");
		YXCS_PASSWORD= resource.getString("testUilt.password");
