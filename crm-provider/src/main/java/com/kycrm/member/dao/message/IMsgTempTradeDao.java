...
public interface IMsgTempTradeDao {
	 ...
	 * @throws
	 */
	public MsgTempTrade aggregateDataByStatus(Map<String, Object> map);
	 ...
	 * @throws
	 */
	public List<Long> findMaxIdByTime(Map<String, Object> map);
	 ...
	 * @throws
	 */
	public List<Long> isExistMsgTrade(Map<String, Object> map);
	
	public void addMsgTempTradeTableIndex(Long uid);
	
	/**
	 * sumPaymentByDate(时间段内付款金额)
	 ...
	 * @throws
	 */
	public MsgTempTrade sumPaymentByDate(Map<String, Object> map);
	...
	public List<MsgTempTrade> listStepCustomerDetail(Map<String, Object> map);
