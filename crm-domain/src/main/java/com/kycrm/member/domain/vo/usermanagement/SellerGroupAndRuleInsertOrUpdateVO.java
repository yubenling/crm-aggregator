 ...
 * @Date 2018年7月16日上午11:45:01
 * @Tags
 */
public class SellerGroupAndRuleInsertOrUpdateVO implements Serializable {

	/**
	 * @Author ZhengXiaoChen
	 * @Date 2018年7月16日上午11:44:57
	 */
	...
	public SellerGroupAndRuleInsertOrUpdateVO() {
		super();

	}

	public SellerGroupAndRuleInsertOrUpdateVO(String uid, String userId, Long ruleId, Long groupId, String groupName,
			String memberGrade, String tradeOrUntradeTime, String tradeTime, String minTradeTime, String maxTradeTime,
			String orderFrom, String tradeNum, String minTradeNum, String maxTradeNum, String orderStatus,
			String closeTradeTime, String minCloseTradeTime, String maxCloseTradeTime, String accumulatedAmount,
			String minAccumulatedAmount, String maxAccumulatedAmount, String sendOrNotSendForGoods,
			String specifyGoodsOrKeyCodeGoods, String numIid, String goodsKeyCode, String itemNum, String minItemNum,
			String maxItemNum, String sendOrNotSendForArea, String province, String city, String averagePrice,
			String minAveragePrice, String maxAveragePrice, String orderTimeSectionStart, String orderTimeSectionEnd,
			String marketingSmsNumber, String minMarketingSmsNumber, String maxMarketingSmsNumber, String sellerFlag,
			String sentFilter, String memberStatus, String remarks) {
		super();
		this.uid = uid;
		this.userId = userId;
		this.ruleId = ruleId;
	...
	public String toString() {
		return "SellerGroupAndRuleInsertOrUpdateVO [uid=" + uid + ", userId=" + userId + ", ruleId=" + ruleId
				+ ", groupId=" + groupId + ", groupName=" + groupName + ", memberGrade=" + memberGrade
				+ ", tradeOrUntradeTime=" + tradeOrUntradeTime + ", tradeTime=" + tradeTime + ", minTradeTime="
				+ minTradeTime + ", maxTradeTime=" + maxTradeTime + ", orderFrom=" + orderFrom + ", tradeNum="
				+ tradeNum + ", minTradeNum=" + minTradeNum + ", maxTradeNum=" + maxTradeNum + ", orderStatus="
				+ orderStatus + ", closeTradeTime=" + closeTradeTime + ", minCloseTradeTime=" + minCloseTradeTime
				+ ", maxCloseTradeTime=" + maxCloseTradeTime + ", accumulatedAmount=" + accumulatedAmount
				+ ", minAccumulatedAmount=" + minAccumulatedAmount + ", maxAccumulatedAmount=" + maxAccumulatedAmount
				+ ", sendOrNotSendForGoods=" + sendOrNotSendForGoods + ", specifyGoodsOrKeyCodeGoods="
				+ specifyGoodsOrKeyCodeGoods + ", numIid=" + numIid + ", goodsKeyCode=" + goodsKeyCode + ", itemNum="
				+ itemNum + ", minItemNum=" + minItemNum + ", maxItemNum=" + maxItemNum + ", sendOrNotSendForArea="
				+ sendOrNotSendForArea + ", province=" + province + ", city=" + city + ", averagePrice=" + averagePrice
				+ ", minAveragePrice=" + minAveragePrice + ", maxAveragePrice=" + maxAveragePrice
				+ ", orderTimeSectionStart=" + orderTimeSectionStart + ", orderTimeSectionEnd=" + orderTimeSectionEnd
				+ ", marketingSmsNumber=" + marketingSmsNumber + ", minMarketingSmsNumber=" + minMarketingSmsNumber
				+ ", maxMarketingSmsNumber=" + maxMarketingSmsNumber + ", sellerFlag=" + sellerFlag + ", sentFilter="
				+ sentFilter + ", memberStatus=" + memberStatus + ", remarks=" + remarks + "]";
	}
