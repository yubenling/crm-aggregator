...
/**
 * 存放可以与msgId匹配的订单(只存15天)
 * @ClassName: MsgMatchTrade  
 * @author ztk
 * @date 2018年6月13日 下午3:55:01
 */
public class MsgTempTrade implements Serializable,ShardingTable{
	 ...
	 * 			 预售效果分析的：create:创建 closed订单关闭 waitPay:未付款  paidFinal催付成功 success成交  refund退款
	 */
