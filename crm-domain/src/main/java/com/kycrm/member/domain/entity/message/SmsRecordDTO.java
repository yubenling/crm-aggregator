 ...
 * 
 * @author zlp
 * @version 1.0 表名 crm_sms_record_dto + 用户id
 */
public class SmsRecordDTO extends BaseEntity implements Serializable, ShardingTable {

	/**
	 * Project Name:s2jh4net File Name:SmsRecordDTO.java Package
	 * Name:s2jh.biz.shop.crm.manage.entity Date:2017年5月31日下午4:36:16 Copyright
	 ...
	 *           "6-发货提醒 7-到达同城提醒 8-派件提醒 9-签收提醒  11-延时发货提醒 12-宝贝关怀 13-付款关怀 " +
	 *           "14-回款提醒  16-自动评价   20-中差评监控 21-中差评安抚 " +
