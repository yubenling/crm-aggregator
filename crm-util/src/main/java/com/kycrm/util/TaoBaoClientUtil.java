...
//	    getTmcUserTopic("哈数据库等哈");
//	    doOpenUserPermit("700021011059035831cd3218af58673c3e08844b56205ec4741ec422c42e3dd913c11aa3309669015", null);
//	    System.out.println(System.getProperties().getProperty("os.name"));
	...
	*/
	public static String creatLink(String token,String linkType,String param){
		...
		if(!"LT_SHOP".equals(linkType) && param==null) {
            return null;
        }
